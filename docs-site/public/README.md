...
The `screenshots/` folder contains all UI screenshots used in the documentation:
...
2. Place them in `docs-site/public/screenshots/`
...
Get-ChildItem "screenshots/*.png" | ForEach-Object { $_.Name }
```
...
## 📞 Supportyourusername/DocForge/issues)
- **Repository**: `https://github.com/yourusername/DocForge`
- **Live Demo**: `https://yourusername.github.io/DocForge/`

Replace `yourusername` with your GitHub username.ues)
- **Repository**: [https://github.com/Ishan96Dev/DocForge](https://github.com/Ishan96Dev/DocForge)
- **Live Demo**: [https://ishan96dev.github.io/DocForge/](https://ishan96dev.github.io/DocForge/)

---

**Built with ❤️ by the DocForge Team**
